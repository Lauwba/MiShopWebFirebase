            ...
            <div class="modal-body form">
                <form method="post" id="form_tarif">
                    ...
                    <div class="form-group">
                        <label>Tipe</label>
                        <input type="text" class="form-control" placeholder="Tipe Tarif" name="tipe_tarif" readonly="">
                    </div>
                    <div class="form-group">
                        <label>Tarif/km</label>
                        <input type="text" class="form-control" placeholder="Nominal Tarif" name="tarif">
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <textarea class="form-control" placeholder="Nominal Tarif" name="ket"></textarea>
                    </div>
                </form>
            </div>
